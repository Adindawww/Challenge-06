...
import { DetailAdinda, SearchAdinda } from '../../redux/actions/AuthMovies';
...
export const DetailPage = () => {
  ...
  const goToSearch = (e) => {
    e.preventDefault();
    //kita menggunakan search movie dari auth movie
    dispatch(SearchAdinda(SearchDataMovie))
          ...
          <div className='relative z-40 p-4'>
            <div className='flex justify-between bg-slate-950'>
              ...
              <div className='gap-3'>
                <button onClick={() => {
                  dispatch(LogOut())
                }} class="text-white w-[6rem] h-[2.5rem] rounded-full font-semibold bg-red-500">Logout</button>
              </div>
            </div>
          </div>
